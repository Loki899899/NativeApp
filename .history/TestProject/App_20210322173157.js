...
const App = () => {
  ...
  return (
    <SafeAreaView style={styles.login}>
      ...
      <Text style={{color:'darkblue', fontSize:17, paddingRight:20,}} onPress={() => {setValue(3)}}>SignUp</Text>
      <Text style={{color:'darkblue', fontSize:17}} onPress={() => {console.log('yes')}}>Forgotten Password</Text>
      </View>
    </SafeAreaView>
  );
};
