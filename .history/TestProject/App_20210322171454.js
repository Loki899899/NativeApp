  ...
  return (
    <SafeAreaView style={styles.login}>
      ...
      <View style={{flex:0.5, flexDirection:'row'}}>
        <Button style={{color:'darkblue', paddingRight:20, fontSize:17,}} title='Sign Up' onClick={() => {alert('abc')}}></Button>
        <Button style={{color:'darkblue', fontSize:17, backgroundColor:'steelblue'}} title='Forgotten password'></Button>
      </View>
    </SafeAreaView>
  );
};
