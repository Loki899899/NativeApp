...
const SignInScreen = ({navigation}) => {
  ...
  return (
    ...
    <View style={{flex:1,flexDirection:'row',width:'80%', justifyContent:'space-between', backgroundColor:'red'}}>
    <Text 
      style={{color:'darkblue', fontSize:17, paddingRight:20, fontWeight:'bold'}} 
