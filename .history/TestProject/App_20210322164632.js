  ...
  return (
    <SafeAreaView style={styles.login}>
      ...
      <View style={{flex:0.5, flexDirection:'row'}}>
        <Button style={{color:'darkblue', paddingRight:20, fontSize:17,}} onClick={() => {alert('abc')}}>Sign Up</Button>
        <Button style={{color:'darkblue', fontSize:17,}}>Forgotten password</Button>
      </View>
    </SafeAreaView>
  );
};
